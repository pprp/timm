...
CUDA_VISIBLE_DEVICES=4,5,6,7 bash ./distributed_train.sh 4 44191 $DATA \
    ...
    --interpolation bicubic --min-lr 1e-5 --mixup 0.15 \
    --num-classes 1000 \
    --resume /home/inspur/project/timm/metapooling_with_procedureB/20221014-084748-mp_mobilenet_v2_050-224/last.pth.tar \
    --output metapooling_with_procedureB \
    --seed 42 \
    --train-interpolation bicubic
