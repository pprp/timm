...
class InvertedResidual(nn.Module):
    def __init__(self, in_channels, out_channels, stride, expand_ratio, idx=6):
        ...
        self.meta = CoordAttention(out_channels)
...
@register_model
def ca_mobilenet_v2(pretrained=False, **kwargs):
    """
...
@register_model
def ca_mobilenet_v2_075(pretrained=False, **kwargs):
    """
    Constructs a MobileNetV2 architecture from
    `"MobileNetV2: Inverted Residuals and Linear Bottlenecks" <https://arxiv.org/abs/1801.04381>`_.
...
@register_model
def ca_mobilenet_v2_050(pretrained=False, **kwargs):
    """
    Constructs a MobileNetV2 architecture from
    `"MobileNetV2: Inverted Residuals and Linear Bottlenecks" <https://arxiv.org/abs/1801.04381>`_.
...
def demo():
    net = ca_mobilenet_v2(num_classes=1000)
